...
class zabbix_api: 
    ...
    # @param date_from
    # @param date_till
    # @param terminal_table
    # @param export_xls ["OFF","ceshi.xls"]
    #
    # @return 
    def history_report(self,history,itemName,date_from,date_till,terminal_table,export_xls): 
...
if __name__ == "__main__":
    ...
    if len(sys.argv)==1:
        ...
        if args.history_report:
            zabbix.history_report(args.history_report[0],args.history_report[1],args.history_report[2],args.history_report[3],terminal_table,export_xls)
        if args.addgroup:
