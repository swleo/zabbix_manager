...
class zabbix_api: 
    ...
    def host_get(self,hostName=''): 
        ...
        try: 
            ...
            table_show.append(["HostID","HostName","Status","Available"])
            ...
            for host in response['result']:      
                ...
                if len(hostName)==0:
                    #print "HostID : %s\t HostName : %s\t Status :\033[32m%s\033[0m \t Available :\033[31m%s\033[0m"%(host['hostid'],host['host'],status[host['status']],available[host['available']])
